...
<g
   id="SvgjsG2383"
   featurekey="jxYttZ-0"
   transform="matrix(2.35552861464431,0,0,2.35552861464431,78.2569081006969,-13.049579014316084)"
   fill="#111111">
  <path
    ...
    <footer className="flex flex-col text-black-100 mt-5 border-t border-gray-100 ">
      <div className="flex max-md:flex-col flex-wrap justify-between gap-5 sm:px-16 px-6 py-10">
        <div className="flex flex-col justify-start items-start gap-6">
          <Image
            src={`data:image/svg+xml;base64,${btoa(logoString)}`}
            alt="logo"
            width={118}
            height={18}
      ...
      <div className="flex justify-between item-center flex-wrap mt-10 border-t border-gray-100 sm:px-16 py-10">
